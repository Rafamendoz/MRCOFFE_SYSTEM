        ...
        ?>
            ...
            <div id="layoutSidenav_content">
				...
				<form id="form" method="POST">
					...
					<div class="row">
						<div class="">
			    			...
			    			<label for="nomal">ID</label>
								...
								<button type="button" onclick = "cancelar()" class="centrarBotonBuscar" value="limpiar">Limpiar</button>
			    		</div>
						</div>
					</div>
					...
					<div class="row">
                        ...
                        <div class="col-lg-4 form-group">
			    			...
			    			<label for="nomal">Fecha contratacion:</label>
								<input type="text" maxlength="60"   class="form-control" id="fechaContratacion"
                    ...
                    <div class="row">
						<div class="col-lg-4 form-group">
                            ...
                            <label for="apeal">Cargos</label>
								...
								<select   id="idcargo" required
								 name="idcargo" title="Id Cargo" class="  form-control form-group" data-live-search="true">
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <label for="apeal">Usuario</label>
								...
								<select   id="idusuarios" required
								 name="idusuarios" title="idusuarios" class="  form-control form-group" data-live-search="true">
								 <?php
					...
					<br/>
					<button id = "ocultar" type="button" onclick = "RegistrarEmpleado()" class="centrarBoton" value="ingresar">Ingresar</button>
					<div id="mostrar" style='display:none' >	
						<button type="button" onclick = "ModificarEmpleado()" class="centrarBoton" value="buenas">Modificar</button>
